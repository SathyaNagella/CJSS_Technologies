...
<h2>Welcome To Update SKU Page</h2><br><hr>
<form:form  action="updateSku"  method="post"  modelAttribute="skuEditObj">
    <form:errors/>
     <table>
           <tr>
               <td>SKU ID </td> <td> <form:input path="skuId" readonly="true"/> </td>
